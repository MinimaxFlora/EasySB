...
// extensionFor gives the downloaded document the extension its format uses.
func extensionFor(client subscribe.Client) string {
	if client == subscribe.ClientMihomo {
		return ".yaml"
	}
