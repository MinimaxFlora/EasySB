...
| Copy and mouse | Subscription and share-link results render as a click-to-copy card grid (click a card, press its number, or `Enter`); `C` copies all, `M` toggles mouse capture. On log screens `C` copies the log (OSC52) |
